...
// gemini-2.5-flash: 500 req/day free tier, fast, supports structured JSON.
// Override via env: gemini-2.5-pro for higher quality, gemini-2.5-flash-lite for higher quota.
